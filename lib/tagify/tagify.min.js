!(function (t, e) {
  ...
  var g = {
      ...
      show: function (t) {
        ...
        if (
          (!c || d || r.templates.dropdownItemNoMatch) &&
          !1 !== r.dropdown.enable &&
          ...
          if (
            ...
            t &&
              ...
              r.templates.dropdownItemNoMatch &&
                (s = r.templates.dropdownItemNoMatch.call(this, { value: t }))),
            !s)
          ) {
            if (this.suggestedListItems.length)
              t &&
                ...
                !n(this.suggestedListItems[0].value, t) &&
            ...
            (i = "" + (o((e = this.suggestedListItems[0])) ? e.value : e)),
              r.autoComplete &&
                i &&
                0 == i.indexOf(t) &&
      ...
      render: function () {
        ...
        return (
          ...
          document.body.contains(this.DOM.dropdown) ||
            ...
            setTimeout(function () {
              return s.DOM.dropdown.classList.remove(
                n.classNames.dropdownInital
              );
            })),
          this
        );
      ...
      fill: function (t) {
        (t =
          ...
          (this.DOM.dropdown.content.innerHTML = l(t));
      },
      refilter: function (t) {
            ...
            switch (t.key) {
              ...
              case "Tab":
                if (
                  ...
                  try {
                    if (i.getAttribute("tagifySuggestionIdx")) {
                      var a = i
                        ? i.textContent
                        : this.suggestedListItems[0].value;
      ...
      selectOption: function (t) {
        ...
        if (!t)
          return (
            ...
            void (i && this.dropdown.hide.call(this))
          );
        var a = t.getAttribute("tagifySuggestionIdx"),
          n = (a ? this.suggestedListItems[+a] : "") || this.input.value;
        if (
        ...
        for (
          ...
          d.fuzzySearch
            ? ((s = p
                ...
                .toLowerCase()),
              (i = (d.accentedSearch ? h(s).indexOf(h(n)) : s.indexOf(n)) >= 0))
            : (i = p.some(function (t) {
                var i = "" + e[t] || "";
                return (
                  d.accentedSearch && ((i = h(i)), (n = h(n))),
                  d.caseSensitive || (i = i.toLowerCase()),
                  0 == i.indexOf(n)
                );
              })),
          (a = !l.duplicates && this.isTagDuplicate(o(e) ? e.value : e)),
          i && !a && u-- && c.push(e),
          0 != u);
          f++
        );
    ...
    callbacks: {
      ...
      onKeydown: function (t) {
            ...
            case "Backspace":
              ...
              var s = document.getSelection(),
                ...
                n =
                  ...
                  (!s.anchorOffset && s.anchorNode.previousElementSibling),
              ...
              if (
                (3 == s.anchorNode.nodeType &&
                  ...
                  t.preventDefault(),
                (n || a) && !this.settings.backspace)
              )
                return void t.preventDefault();
              setTimeout(function () {
                if (
                  r(e.DOM.input.innerHTML).length >= o.length &&
                  (e.removeTags(s.anchorNode.previousElementSibling),
                  e.fixFirefoxLastTagNoCaret(),
                  2 == e.DOM.input.children.length &&
                    "BR" == e.DOM.input.children[1].tagName)
                )
        ...
        switch (t.key) {
          ...
          case "ArrowRight":
            ...
            if (d && this.settings.autoComplete.rightKey)
              return void this.addTags([d], !0);
            break;
          case "Tab":
            if ((t.preventDefault(), !i || "select" == this.settings.mode))
              return !0;
          case "Enter":
      ...
      onMixTagsInput: function (t) {
        ...
        if (
          ...
          if (
            ...
            (a =
              (i = e.toString().slice(0, e.endOffset)).split(h.pattern).length -
              1),
            (s = i.match(h.pattern)) &&
              (n = i.slice(i.lastIndexOf(s[s.length - 1]))),
            n)
          ) {
            (this.state.actions.ArrowLeft = !1),
              ...
              (o = this.state.tag.value.length >= h.dropdown.enabled);
            try {
              (l =
        ...
        setTimeout(function () {
          d.update({ withoutChangeEvent: !0 }),
            d.trigger(
              "input",
              c({}, d.state.tag, { textContent: d.DOM.input.textContent })
            ),
            d.state.tag &&
              d.dropdown[o ? "show" : "hide"].call(d, d.state.tag.value);
        }, 10);
      },
      ...
      onEditTagInput: function (t, e) {
        ...
        o || !0 !== t.originalIsValid || (r = !0),
          i.classList.toggle(this.settings.classNames.invalid, !0 !== r),
          (a.__isValid = r),
          ...
          n
            ? (this.settings.transformTag.call(this, a),
              !0 === (o = this.validateTag(a))
                ? ((a =
                    this.getWhitelistItemsByValue(s)[0] ||
                    a.__preInvalidData ||
                    {}),
    ...
    (f.prototype = {
      ...
      templates: {
        wrapper: function (t, e) {
          return '<tags class="'
            ...
            .concat(
              e.mode
                ? "".concat(e.classNames.namespace, "--").concat(e.mode)
                : "",
              " "
            )
            .concat(t.className, '"\n                    ')
      ...
      parseTemplate: function (t, e) {
        return (
          ...
          this.parseHTML(l(t.apply(this, e)))
        );
      },
      ...
      build: function (t) {
        ...
        (e.originalInput = t),
          ...
          (e.input = e.scope.querySelector(
            "." + this.settings.classNames.input
          )),
      ...
      editTag: function (t, e) {
        ...
        if (s) {
          if (!(n instanceof Object && "editable" in n) || n.editable)
            return (
              (t.__tagifyTagData.__originalData = c({}, n)),
      ...
      setRangeAtStartEnd: function (t, e) {
        ...
        i.rangeCount >= 1 &&
          ["Start", "End"].forEach(function (s) {
            return i.getRangeAt(0)["set" + s](e, t ? 0 : e.length);
          });
      },
      injectAtCaret: function (t, e) {
        if ((e = e || this.state.selection.range))
          return (
            ...
            this.setRangeAtStartEnd(!0, t.nextSibling),
      ...
      input: {
        ...
        validate: function () {
          var t =
            !this.input.value ||
            !0 === this.validateTag({ value: this.input.value });
          return (
      ...
      tagData: function (t, e) {
        return t
          ? (e && (t.__tagifyTagData = c({}, t.__tagifyTagData || {}, e)),
            t.__tagifyTagData)
      ...
      isTagDuplicate: function (t) {
        ...
        return (
          "select" != e.mode &&
          this.value.reduce(function (i, s) {
            return n(("" + t).trim(), s.value, e.dropdown.caseSensitive)
              ? i + 1
              : i;
          }, 0)
        );
      ...
      getTagIndexByValue: function (t) {
        ...
        return (
          this.getTagElms().forEach(function (s, a) {
            n(s.textContent.trim(), t, e.settings.dropdown.caseSensitive) &&
              i.push(a);
          }),
          i
        );
      ...
      isTagWhitelisted: function (t) {
        return this.settings.whitelist.some(function (e) {
          return "string" == typeof t
            ? n(t.trim(), e.value || e)
            : n(JSON.stringify(e), JSON.stringify(t));
        });
      },
          ...
          e
            ? i.pattern && i.pattern instanceof RegExp && !i.pattern.test(e)
              ...
              : (this.isTagBlacklisted(e) ||
                  (i.enforceWhitelist && !this.isTagWhitelisted(e))) &&
        ...
        return (
          l &&
            (t.forEach(function (t) {
              var i = e.getWhitelistItemsByValue(t.value)[0];
      ...
      getWhitelistItemsByValue: function (t) {
        return this.settings.whitelist.filter.call(this, function (e) {
          return (
            "value" in e &&
            n(e.value || e, t, this.settings.dropdown.caseSensitive)
          );
        });
      },
        ...
        return (
          (t = t
            ...
            .map(function (t, i) {
              ...
              if (
                !(c.length > 1) ||
                (o && !e.isTagWhitelisted(l.value)) ||
                (!a && e.isTagDuplicate(l.value))
              ) {
      ...
      replaceTextWithNode: function (t, e) {
        if (this.state.tag || e) {
          ...
          var i,
            ...
            n = a.anchorNode;
          return (
            n.splitText(a.anchorOffset),
            (i = n.nodeValue.lastIndexOf(e)),
            ((s = n.splitText(i)).nodeValue = s.nodeValue.replace(e, "")),
            n.parentNode.insertBefore(t, s),
            s
          );
        }
      },
              ...
              : ("select" == n.mode && (e = !1),
                ...
                t.forEach(function (t) {
                  ...
                  if (
                    ...
                    (t.__isValid = i.hasMaxTags() || i.validateTag(t)),
                    !0 !== t.__isValid)
                  ) {
                    if (s) return;
                    c(o, i.getInvaildTagParams(t, t.__isValid), {
                      __preInvalidData: r,
                    }),
      ...
      addMixTags: function (t) {
        ...
        return (
          ...
          this.update(),
          (this.state.tag = null),
          this.trigger("add", c({}, { tag: e }, { data: t[0] })),
          setTimeout(function () {
      ...
      reCheckInvalidTags: function () {
        var t = this,
          e = this.settings,
          i = "."
            .concat(e.classNames.tag, ".")
            .concat(e.classNames.tagNotAllowed),
