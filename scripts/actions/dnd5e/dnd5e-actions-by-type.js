...
export class ActionHandler5eGroupByType extends ActionHandler5e {
  ...
  _buildActionCategory(token, title, actions) {
    ...
    category.name = this.i18n(`tokenActionHud.dnd5e.${title}`);
    ...
    this._subCategorizeEquipment(
      ...
      category,
      actions,
      this.i18n("tokenActionHud.dnd5e.weapons"),
      (i) => i.type == "weapon"
    );
    this._subCategorizeEquipment(
      token,
      category,
      actions,
      this.i18n("tokenActionHud.dnd5e.equipment"),
      (i) => i.type == "equipment"
    );
    this._subCategorizeEquipment(
      token,
      category,
      actions,
      this.i18n("tokenActionHud.dnd5e.consumables"),
      (i) => i.type == "consumable"
    );
    this._subCategorizeEquipment(
      token,
      category,
      actions,
      this.i18n("tokenActionHud.dnd5e.tools"),
      (i) => i.type == "tool"
    );
    this._subCategorizeEquipment(
      token,
      category,
      actions,
      this.i18n("tokenActionHud.dnd5e.other"),
      (i) => true
    );
